%% Courtesy: Daniel Spielman, via Madhu Sudan, via Vinod.
...
\newcommand{\handout}[5]{
   ...
   \framebox{
      \vbox{
    \hbox to 4.78in { {\bf CS 6993 Independent Study}
     	 \hfill #2 }
       \vspace{4mm}
       \hbox to 4.78in { {\Large \hfill #5  \hfill} }
       \vspace{2mm}
...
\newcommand{\lecture}[4]{\handout{#1}{#2}{Author:#3}{Advisor:#4}{#1}}
